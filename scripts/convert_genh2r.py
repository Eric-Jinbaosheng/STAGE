...
from h2r_schema.adapters.genh2r import GenH2RMap, convert_episode_file


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Convert GenH2R style records to unified episode JSONL.")
    ...
    parser.add_argument("--mapping", default="", help="Optional mapping JSON path.")
    return parser.parse_args()


def load_mapping(mapping_path: str) -> GenH2RMap:
    if not mapping_path:
        return GenH2RMap()
    ...
    return GenH2RMap.from_dict(raw)
